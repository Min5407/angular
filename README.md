...
# Angular components / Services / server
 ...
 This project has few files inside a server folder.
  ...
  ## Test
       ...
       In terminal, make sure that you are in assingmnet1 folder and server is running (go into server folder and type “node server.js”) and type “npm run-script testintegrationTest” to test the routes of this angular project
